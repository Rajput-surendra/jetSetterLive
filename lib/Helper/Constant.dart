...
const String appName = 'Jetsetter India';

//Your package name
const String packageName = 'jetsetter.user';
const String iosPackage = 'jetsetter.user';
...
const String issuerName = 'Jetsetter India';
