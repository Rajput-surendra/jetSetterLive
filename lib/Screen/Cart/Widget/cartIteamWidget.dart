      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            //     ),
            //     Text(
            //       "${cartList[index].singleItemNetAmount} x ${cartList[index].qty} ",
            ...
            Row(
              ...
              children: [
                ...
                Text(
                 ...
                 // /* DesignConfiguration.getPriceFormat(
                 //    context,
                 //    (((double.parse(cartList[index].singleItemNetAmount!)) * double.parse(cartList[index].qty!)) + (((double.parse(cartList[index].singleItemTaxAmount!)) * double.parse(cartList[index].qty!)))),
                 //  )!*/
                  style: TextStyle(
                    fontFamily: 'ubuntu',
                    fontWeight: FontWeight.bold,
