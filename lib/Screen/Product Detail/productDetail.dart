      ...
      if (isNetworkAvail) {
        ...
        if (CUR_USERID != null) {
          try {
            ...
            print('__________${from}_________');
            print('__________${CurrentSellerID == '' ||
                CurrentSellerID == widget.model!.seller_id!}_________');
      ...
      if (isNetworkAvail) {
        try {
          if (notificationisloadmore) {
           ...
           print('____zxxz______${parameter}_________');
  ...
  Future<void> getProduct() async {
    ...
    if (isNetworkAvail) {
      try {
       ...
       print('______ssss____${parameter}_________');
        if (CUR_USERID != null) parameter[USER_ID] = CUR_USERID;
