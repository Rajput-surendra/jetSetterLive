                            ...
                            children: [
                             ...
                             //getCurrentLocationCard(),
                              ...
                              Padding(
                                ...
                                child: Text("Enjoy The World  With Us",style: TextStyle(color: colors.blackTemp,fontWeight: FontWeight.bold,fontSize: 16),),
                              ),
                              Padding(
                                padding: const EdgeInsets.only(left: 10),
                                child: Text("Food delivery & Find awesome hotel, Flights, Tour, Activities",style: TextStyle(color: colors.blackTemp,fontWeight: FontWeight.normal,fontSize: 12),),
                              ),
                           ...
                           //   Text("Let's The World Together!"),
                             ...
                             brandcard()*/
                              ...
                              const Padding(
                                ...
                                child: Text("All Restaurant",style: TextStyle(color: colors.blackTemp,fontWeight: FontWeight.bold,fontSize: 16),),
                              ),
                              const SizedBox(height: 10,),
              ...
              child: Row(
                ...
                children: [
                  InkWell(
                    ...
                    //setSnackbar1("Comming soon hotel");
                    },
                    child: Column(
                      children: [
                        Image.asset("assets/images/png/hotel.png",height: 50,width: 50,),
                        SizedBox(height: 5,),
                        Text("Hotel")
                      ],
                    ),
                  ...
                  InkWell(
                    onTap: (){
                      ...
                      //setSnackbar1("Comming soon activity");
                    },
                    child: Column(
                      children: [
                        Image.asset("assets/images/png/activity.png",height: 50,width: 50,),
                        SizedBox(height: 5,),
                        Text("Activities")
                      ],
                    ),
                  ...
                  InkWell(
                    ...
                    child: Column(
                      children: [
                        Image.asset("assets/images/png/plan.png",height: 50,width: 50,),
                        SizedBox(height: 5,),
                        Text("Plane")
                      ],
                    ),
                  ...
                  InkWell(
                    onTap: (){
                     ...
                     // setSnackbar1("Comming soon train");
                    },
                    child: Column(
                      children: [
                        Image.asset("assets/images/png/train.png",height: 50,width: 50,),
                        SizedBox(height: 5,),
                        Text("Train")
                      ],
                    ),
                ...
                children: [
                  InkWell(
                    onTap: (){
                      ...
                      //setSnackbar1("Comming soon bus");
                    },
                    child: Column(
                      children: [
                        Image.asset("assets/images/png/bus.png",height: 50,width: 50,),
                        SizedBox(height: 5,),
                        Text("Bus")
                      ],
                    ),
                  ...
                  InkWell(
                    ...
                    child: Column(
                      children: [
                        Image.asset("assets/images/png/taxi.png",height: 50,width: 50,),
                        SizedBox(height: 5,),
                        Text("Taxi")
                      ],
                    ),
                  ...
                  InkWell(
                    onTap: (){
                     ...
                     // setSnackbar1("Comming soon passport");
                    },
                    child: Column(
                      children: [
                        Image.asset("assets/images/png/passport.png",height: 50,width: 50,),
                        SizedBox(height: 5,),
                        Text("Passport")
                      ],
                    ),
                  ...
                  InkWell(
                    onTap: (){
                      ...
                      //setSnackbar1("Comming soon visa");
                    },
                    child: Column(
                      children: [
                        Image.asset("assets/images/png/visa.png",height: 50,width: 50,),
                        SizedBox(height: 5,),
                        Text("Visa")
                      ],
                    ),
